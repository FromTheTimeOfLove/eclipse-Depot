...
var Layout = function() {
	...
	var handleSidebarAndContentHeight = function() {
		...
		if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
			...
			$(".J_iframe").css('min-height', '' + height + 'px');
		...
		$('.page-sidebar-menu').on(
				...
				function(e) {
					...
					if (App.getViewPort().width >= resBreakpointMd && !$('.page-sidebar-menu').attr("data-initialized")
							&& $('body').hasClass('page-sidebar-closed') && that.parent('li').parent('.page-sidebar-menu').size() === 1) {
						return;
					}
	...
	var handle100HeightContent = function() {
		...
		$('.full-height-content').each(
				function() {
					...
					height = App.getViewPort().height - $('.page-header').outerHeight(true) - $('.page-footer').outerHeight(true)
							- $('.page-title').outerHeight(true) - $('.page-bar').outerHeight(true);
					...
					if (target.hasClass('portlet')) {
						...
						height = height - target.find('.portlet-title').outerHeight(true) - parseInt(target.find('.portlet-body').css('padding-top'))
