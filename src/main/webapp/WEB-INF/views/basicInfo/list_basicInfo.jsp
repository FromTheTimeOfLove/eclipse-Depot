...
<body>
					...
					<form class="form-horizontal" role="form" id="BasicInfoListForm">
						...
						<div class="form-body form-body-size">
							<div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <select class="js-example-placeholder-single form-control" name="stageId">
						...
						<div class="form-actions right">
							<div class="row">
								<div class="col-md-12">
									<!-- <button type="button" class="btn btn-sm green" id="file">
										File
									</button> -->
									<button type="button" class="btn btn-sm green" id="basicInfoSearchBt">
										<fmt:message key="PAGE.GEN.SEARCH" />
									</button>
									<button type="reset" class="btn btn-sm green" onclick="SelectUtils.resetSelectVal();BasicInfo.resetSession();" id="basicInfoResetBt">
    ...
    <script src="static/basicInfo/scripts/basicInfo.js" type="text/javascript"></script>
