...
<body>
		...
		<div class="col-md-12">
			...
			<div class="portlet box green">
				...
				<div class="portlet-body form">
					<form class="form-horizontal" role="form" id="warrantTrackerForm">
						...
						<div class="form-actions right">
							<div class="row">
								<div class="col-md-12">
									<button type="button" class="btn btn-sm green" id="warrantTrackerSearchBt">
										<fmt:message key="PAGE.GEN.SEARCH" />
									</button>
									<button type="reset" onclick="SelectUtils.resetSelectVal();" class="btn btn-sm green" id="warrantTrackerResetBt">
										<fmt:message key="PAGE.GEN.RESET" />
									</button>
									<button type="button" class="btn btn-sm green" id="warrantTrackerExportBt">
    ...
    <script type="text/javascript" src="static/warrantTracker/scripts/warrantTracker.js"></script>
</body>
</html>
