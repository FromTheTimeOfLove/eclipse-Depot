			...
			<div class="portlet-body">
				...
				<div class="portlet">
						...
						<div class="table-scrollable">
							<table class="table table-bordered table-hover">
								<tr>
									...
									<td><input type="text" class="form-control"  placeholder=""  value="${basicinfo.portfolioCH}" readonly="true"></td>
									<td style="text-align:right;vertical-align:middle;">Portfolio name (EN)</td>
									<td><input type="text" class="form-control"  placeholder=""  value="${basicinfo.portfolioEN}" readonly="true"></td>
									<td style="text-align:right;vertical-align:middle;">Date of Sign</td>
									<td>
										<div class="input-icon input-icon-sm right">
											<i class="fa fa-calendar"> </i>
											<input type="text" class="form-control input-sm date dataTimeTest" placeholder="yyyy-mm-dd" value="${basicinfo.portfolioEN}"  readonly />
										</div>							
									</td>
								</tr>
								<tr>
					...
					<div class="portlet-title form">
						...
						<div class="col-md-3">
							<select id="moneyType" onchange="changeMoneyType()" class="js-select">
