...
<div id="USER_ROLE_DIV" class="form dd-edit-form">
	...
	<form id="USER_ROLE_FORM" class="form-horizontal" role="form">
		<input type="hidden" name="userId" id="userId" value="${userId}" />
		<div class="form-body" style="display: none;">
			<div class="form-actions">
				<div class="row">
					<div class="col-md-12" align="center">
						<button type="button" class="btn btn-primary" id="saveUserBt" onclick="User.saveUserRole();">
...
<script>
	...
	function initUserRole(id) {
		...
		$.ajax({
			...
			url : 'rest/user/findRoleTree.do',// 请求的action路径
