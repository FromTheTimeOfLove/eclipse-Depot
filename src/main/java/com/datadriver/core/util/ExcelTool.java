...
public class ExcelTool {
     ...
     */
    public void writeToFile(String filePath,String[] sheetName,List<? extends Object[]> title,List<? extends List<? extends Object[]>> data) throws FileNotFoundException, IOException{
        //创建并获取工作簿对象
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        new ExcelTool().writeToFile("D:\\xx.xlsx", sheetName, titles, data_);
    }
}