package com.datadriver.web.dealtracker.controller;
 ...
 */
@Controller
@RequestMapping(value = "/dealtracker")
public class dealtrackerController {
	 ...
	 * @throws
	 */
	@RequestMapping(value = "/initFinanceDealtracker.do", method = RequestMethod.GET)
	public String initFinanceDealtracker() {
		return "dealtracker/list_dealtracker";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/findListDealtracker.do", method = RequestMethod.POST)
	@ResponseBody
	public DataTablePage<BasicInfo> findListDealtracker(Model model,
