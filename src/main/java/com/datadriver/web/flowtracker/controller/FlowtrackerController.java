package com.datadriver.web.flowtracker.controller;
 ...
 */
@Controller
@RequestMapping(value = "/flowtracker")
public class FlowtrackerController {
	 ...
	 * @throws
	 */
	@RequestMapping(value = "/initFinanceflowtracker.do", method = RequestMethod.GET)
	public String initListBasicInfo() {
		return "flowtracker/list_flowtracker";
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/findListFlowtracker.do", method = RequestMethod.POST)
	@ResponseBody
	public DataTablePage<BasicInfo> findListFlowtracker(Model model,
